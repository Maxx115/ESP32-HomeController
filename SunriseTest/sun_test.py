...
def calc(
    ...
    #n = ceil(J_date - (2451545.0))
    log.debug(f'Julian day2            n       = {n:.3f} days')
    ...
    #M_degrees = (357.5291 + 0.9856 * J_) % 360
    ...
    L_degrees = (M_degrees + C_degrees + 180.0 + 102.9372) % 360
    ...
    #sin_d = sin(Lambda_radians) * sin(0.40909994068)
...
def main():
    ...
    latitude = 52.04988349511029
    longitude = 10.388119797982146
    elevation = 0
    time_new = 1678439851.8041296
    print(calc(time(), latitude, longitude, elevation, debugtz=timezone(timedelta(hours=1), 'fake-zone')))
    print(calc(time_new, latitude, longitude, elevation, debugtz=timezone(timedelta(hours=1), 'fake-zone')))
